...
public class ShowAllOnMap extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbHelper = new DatabaseHelper(ShowAllOnMap.this);
        ...
        btn_select.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (selectedId != null) {
                    Intent intent = new Intent(ShowAllOnMap.this, ViewPost.class);
