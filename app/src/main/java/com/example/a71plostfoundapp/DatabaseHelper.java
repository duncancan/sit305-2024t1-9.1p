...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public List<PostModel> getAll() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                postModel = new PostModel(postId, postType, itemName, itemDescription, itemFoundDate, itemFoundLocation, finderName, finderPhone);
                returnList.add(postModel);
    ...
    public PostModel getPostById(int id) {
        ...
        if (cursor.moveToFirst()) {
            ...
            postModel = new PostModel(-1, "Error", "", "", "", "", "", "");
        }
