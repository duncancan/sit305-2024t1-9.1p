...
import com.example.a71plostfoundapp.databinding.ActivityMapsCreateBinding;
...
public class CreateNewShowMap extends FragmentActivity implements OnMapReadyCallback {

    private GoogleMap mMap;
    private ActivityMapsCreateBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityMapsCreateBinding.inflate(getLayoutInflater());
    ...
    public void onMapReady(GoogleMap googleMap) {
        mMap = googleMap;
        // Set default map location to around Deakin
